# -*- coding: utf-8 -*-
#
# InnoDB data recovery tool  documentation build configuration file, created by
# sphinx-quickstart on Thu Dec 18 15:45:04 2015.
#
...
project = u'InnoDB data recovery tool documentation'
copyright = u'Percona LLC and/or its affiliates 2011-2015'
...
html_title = 'InnoDB Data Recovery Tool Documentation'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'InnoDB Data Recovery Tool Documentation'
...
htmlhelp_basename = 'InnodbDataRecoveryTool'
...
latex_documents = [
  ('index', 'InnoDB-Data-Recovery-Tool.tex', u'InnoDB Data Recovery Tool',
   u'Percona LLC and/or its affiliates 2011-2015', 'manual'),
]
...
#man_pages = [
#    ('index', 'tokumx', u'InnoDB Data Recovery Tool  Documentation',
